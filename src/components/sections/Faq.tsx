...
const QA = [
  ...
  {
    q: 'Можно ли выгнуть элемент дугой?',
    a: 'Да. У каждого объекта в панели свойств есть ползунок «Изгиб»: он гнёт фигуру по дуге от прямой линии до замкнутого кольца. Придумано в первую очередь для липидного бислоя вокруг клетки, но работает с любым элементом, включая импортированные из ChemDraw. В библиотеке уже лежат готовые заготовки «Бислой дугой» и «Бислой кольцом».',
  },
  {
