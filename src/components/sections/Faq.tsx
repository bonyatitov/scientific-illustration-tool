...
const QA = [
  ...
  {
    q: 'Где взять греческие буквы и научные знаки?',
    a: 'В библиотеке есть вкладка «Символы»: весь греческий алфавит строчными и прописными, математические знаки (≈, ±, ≤, ∑, ∫, ∞), единицы вроде °C и мкм, а также стрелки реакций и равновесия ⇌. Клик добавляет символ на холст как обычный текст — размер, цвет и курсив меняются справа.',
  },
  {
